...
const Menu = () => {
  ...
  return (
    <div>
      {!open ? (
        <Image className='cursor-pointer' src="/open.png" alt='' width={20} height={20} onClick={()=> setOpen(true)}/>
      ) : (
        <Image className='cursor-pointer' src="/close.png" alt='' width={20} height={20} onClick={() => setOpen(false)} />
      )}
      {open && (
