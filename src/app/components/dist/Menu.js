...
var Menu = function () {
    ...
    return (react_1["default"].createElement("div", null,
        ...
        react_1["default"].createElement("div", { className: 'bg-red-500 text-white' }, links.map(function (item) { return (react_1["default"].createElement(link_1["default"], { href: item.url, key: item.id }, item.title)); }))));
};
